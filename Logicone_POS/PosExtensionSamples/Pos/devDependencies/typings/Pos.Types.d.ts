...
declare namespace Commerce.Proxy.Entities {
    ...
    interface DeviceConfiguration {
        ...
        DiagnosticsConfigurationOverride?: string;
        ExtensionProperties?: Entities.CommerceProperty[];
    }
    ...
    interface CartConfiguration {
        ...
        AllowedMinimumDaysForRequestDelivery?: number;
        AllowedMaximumDaysForRequestDelivery?: number;
        ExtensionProperties?: Entities.CommerceProperty[];
    }
...
declare namespace Commerce {
    class PaymentTerminalRefundPaymentRequest<TResponse extends PaymentTerminalRefundPaymentResponse> extends Request<TResponse> {
        ...
        readonly extensionTransactionProperties: Commerce.Client.Entities.IExtensionTransaction;
        readonly isDebitPreferred: boolean;
        readonly paymentTransactionReferenceData: Client.Entities.IPaymentTransactionReferenceData | undefined;
        constructor(paymentConnectorId: string, amount: number, tenderInfo: Client.Entities.ITenderInfo, isManualEntry: boolean, extensionTransactionProperties: Commerce.Client.Entities.IExtensionTransaction, correlationId?: string, isDebitPreferred?: boolean, paymentTransactionReferenceData?: Client.Entities.IPaymentTransactionReferenceData);
    }
}
declare namespace Commerce {
